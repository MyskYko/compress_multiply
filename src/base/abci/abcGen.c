...
***********************************************************************/
void Abc_Write4to2Compressor( FILE * pFile )
{
    fprintf( pFile, ".model Compressor\n" );
    fprintf( pFile, ".inputs x1 x2 x3 x4\n" ); 
    fprintf( pFile, ".outputs s c\n" ); 
    fprintf( pFile, ".names x1 x3 n7\n" ); 
    fprintf( pFile, "00 1\n" ); 
    fprintf( pFile, ".names x1 x3 n10\n" ); 
    fprintf( pFile, "11 1\n" ); 
    fprintf( pFile, ".names x2 x4 n8\n" ); 
    fprintf( pFile, "00 1\n" ); 
    fprintf( pFile, ".names x2 x4 n11\n" ); 
    fprintf( pFile, "11 1\n" ); 
    fprintf( pFile, ".names n7 n8 n9\n" ); 
    fprintf( pFile, "00 1\n" ); 
    fprintf( pFile, ".names n10 n11 n12\n" ); 
    fprintf( pFile, "00 1\n" ); 
    fprintf( pFile, ".names n9 n12 n13\n" ); 
    fprintf( pFile, "11 0\n" ); 
    fprintf( pFile, ".names n9 c\n" ); 
    fprintf( pFile, "1 1\n" );
    fprintf( pFile, ".names n13 s\n" ); 
    fprintf( pFile, "1 1\n" );
    fprintf( pFile, ".end\n" ); 
    fprintf( pFile, "\n" ); 
}
void Abc_WriteAdder4to2Compressor( FILE * pFile, int nVars )
{
    int i, nDigits = Abc_Base10Log( nVars );
    ...
    if ( nVars%2 == 1 )
      {
	printf("The size must be even\n");
	return;
      }
    
    for ( i = 0; i < nVars/2; i++ )
      fprintf( pFile, ".subckt Compressor x1=a%0*d x2=a%0*d x3=b%0*d x4=b%0*d s=s%0*d c=s%0*d\n", nDigits, i*2, nDigits, i*2+1, nDigits, i*2, nDigits, i*2+1, nDigits, i*2, nDigits, i*2+1 );

    fprintf( pFile, ".end\n" ); 
    fprintf( pFile, "\n" );
    Abc_Write4to2Compressor( pFile );
}
void Abc_GenAdder4to2Compressor( char * pFileName, int nVars )
{
    FILE * pFile;
    assert( nVars > 0 );
    pFile = fopen( pFileName, "w" );
    fprintf( pFile, "# %d-bit ripple-carry adder generated by ABC on %s\n", nVars, Extra_TimeStamp() );
    Abc_WriteAdder4to2Compressor( pFile, nVars );
    fclose( pFile );
}
void Abc_WriteMulti4to2Compressor( FILE * pFile, int nVars )
{
    ...
    fprintf( pFile, ".end\n" ); 
    fprintf( pFile, "\n" );
    Abc_WriteAdder4to2Compressor( pFile, 2*nVars );
}
void Abc_GenMulti4to2Compressor( char * pFileName, int nVars )
{
    ...
    pFile = fopen( pFileName, "w" );
    fprintf( pFile, "# %d-bit multiplier generated by ABC on %s\n", nVars, Extra_TimeStamp() );
    Abc_WriteMulti4to2Compressor( pFile, nVars );
    fclose( pFile );
}
